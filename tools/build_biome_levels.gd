...
func _build_desert_terraces() -> void:
	...
	LevelKit.write_map({
		...
		"music": "res://assets/audio/music/al_kharid.ogg",
		"playlist": ["res://assets/audio/music/arabian_2.ogg"],
		"layers": {
...
func _build_desert_tombs() -> void:
	...
	LevelKit.write_map({
		...
		"music": "res://assets/audio/music/arabian_2.ogg",
		"playlist": [],
		"layers": {
			"Ground": LevelKit.b64(ground),
			"Walls": LevelKit.b64(walls),
...
func _build_forge_gallery() -> void:
	...
	LevelKit.write_map({
		...
		"music": "res://assets/audio/music/attack_3.ogg",
		"playlist": [],
		"layers": {
			"Ground": LevelKit.b64(ground),
			"Walls": LevelKit.b64(walls),
...
func _build_forge_deeps() -> void:
	...
	LevelKit.write_map({
		...
		"playlist": ["res://assets/audio/music/attack_3.ogg"],
		"layers": {
			"Ground": LevelKit.b64(ground),
			"Walls": LevelKit.b64(walls),
			"Props": LevelKit.b64(props),
