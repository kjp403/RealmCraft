...
ROSTER = [
    ...
    # Pets. Every one is a scripted companion (CosmeticPresetLibrary) and none
    # of these strips is ever drawn in game - they exist only to hold a registry
    # entry, like the mythic tier's. A plain gold halo keeps the fallback honest:
    # if a pet's preset ever goes missing, it shows as an obvious placeholder.
    ("pet_axolotl",          fx_halo,            const("gold")),
    ("pet_baby_dragon",      fx_halo,            const("gold")),
    ("pet_bumblebee",        fx_halo,            const("gold")),
    ("pet_clockwork_owl",    fx_halo,            const("gold")),
    ("pet_cloud_pup",        fx_halo,            const("gold")),
    ("pet_corgi",            fx_halo,            const("gold")),
    ("pet_crab",             fx_halo,            const("gold")),
    ("pet_crystal_golem",    fx_halo,            const("gold")),
    ("pet_duckling",         fx_halo,            const("gold")),
    ("pet_ember_imp",        fx_halo,            const("gold")),
    ("pet_fireflies",        fx_halo,            const("gold")),
    ("pet_frog",             fx_halo,            const("gold")),
    ("pet_ghost",            fx_halo,            const("gold")),
    ("pet_hamster_ball",     fx_halo,            const("gold")),
    ("pet_jellyfish",        fx_halo,            const("gold")),
    ("pet_kitsune",          fx_halo,            const("gold")),
    ("pet_mimic",            fx_halo,            const("gold")),
    ("pet_moth",             fx_halo,            const("gold")),
    ("pet_mushroom_sprout",  fx_halo,            const("gold")),
    ("pet_owl",              fx_halo,            const("gold")),
    ("pet_penguin",          fx_halo,            const("gold")),
    ("pet_pet_rock",         fx_halo,            const("gold")),
    ("pet_phoenix_chick",    fx_halo,            const("gold")),
    ("pet_pocket_moon",      fx_halo,            const("gold")),
    ("pet_pumpkin_lantern",  fx_halo,            const("gold")),
    ("pet_red_panda",        fx_halo,            const("gold")),
    ("pet_slime",            fx_halo,            const("gold")),
    ("pet_snail",            fx_halo,            const("gold")),
    ("pet_spellbook",        fx_halo,            const("gold")),
    ("pet_star_sprite",      fx_halo,            const("gold")),
    ("pet_baby_griffin",     fx_halo,            const("gold")),
    ("pet_bunny",            fx_halo,            const("gold")),
