...
function build() {
  ...
  // The Ark Coin mark. Generated by tools/build_ark_coin_icon.py — the SAME
  // file the game loads, so the coin on a price tag here and the coin in the
  // HUD cannot drift apart.
  fs.copyFileSync(path.join(SRC, "ark-coin.png"), path.join(DIST, "ark-coin.png"));
  copyFonts();
