...
## Assigns a new Slayer task from the master the player is talking to.
...
func data_request_handler(peer_id: int, instance: ServerInstance, args: Dictionary) -> Dictionary:
	...
	var result: Dictionary = SlayerTaskService.assign_task(player.player_resource, source.master)
